...
describe('CalcComponent', () => {
  ...
  it('has My Calculator as heading in html', () => {
    const calcCompHTML = fixture.nativeElement as HTMLElement; //taking of comp html for testing
    expect(calcCompHTML.querySelector('h2')?.textContent).toMatch(
      /my calculator/i
    );
  });

  it('has add method that add two numbers properly', () => {
